...
def _build_file_descriptor() -> _descriptor_pb2.FileDescriptorProto:
    ...
    response_detected_log_type = upload_response.field.add()
    response_detected_log_type.name = "detected_log_type"
    response_detected_log_type.number = 4
    response_detected_log_type.label = _descriptor_pb2.FieldDescriptorProto.LABEL_OPTIONAL
    response_detected_log_type.type = _descriptor_pb2.FieldDescriptorProto.TYPE_STRING
